...
export function Leaderboard1() {
  // Hard-coded teams
  const initialTeams = [
    { id: 1, team: "Wolves", wins: 9, losses: 1 },
    { id: 2, team: "Dragons", wins: 8, losses: 2 },
    { id: 3, team: "Sharks", wins: 7, losses: 3 },
    { id: 4, team: "Tigers", wins: 6, losses: 4 },
    { id: 5, team: "Eagles", wins: 5, losses: 5 },
  ];

  const [teams, setTeams] = useState([]);

  useEffect(() => {
    // Sort and assign rank on load
              ...
              <div className="flex-1 max-w-[200px]">
                <Card className="bg-linear-to-br from-gray-100 to-gray-200 border-4 border-gray-300 shadow-lg transform transition-transform hover:scale-105">
                  <CardContent className="pt-6 pb-8 text-center">
                    <div className="mb-3 flex justify-center">{getRankIcon(2, 40)}</div>
              ...
              <div className="flex-1 max-w-[220px]">
                <Card className="bg-linear-to-br from-yellow-300 to-yellow-500 border-4 border-yellow-400 shadow-2xl transform transition-transform hover:scale-105">
                  <CardContent className="pt-8 pb-10 text-center">
                    <div className="mb-4 flex justify-center">{getRankIcon(1, 48)}</div>
              ...
              <div className="flex-1 max-w-[200px]">
                <Card className="bg-linear-to-br from-orange-200 to-orange-400 border-4 border-orange-300 shadow-lg transform transition-transform hover:scale-105">
                  <CardContent className="pt-6 pb-6 text-center">
                    <div className="mb-3 flex justify-center">{getRankIcon(3, 36)}</div>
