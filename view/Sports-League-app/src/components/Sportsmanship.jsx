...
  {/* Dynamic Image Definitions based on login state */}
  const mainImage = isLoggedIn
    ? "/images/community/respect.jpeg" 
    : "https://images.unsplash.com/photo-1475440197469-e367ec8eeb19?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"; // Public URL for guests

  const sideImages = isLoggedIn
    ? [
        { src: "/images/community/unity.webp", title: "Unity & Support", subtitle: "We win together, we lose together" },
        { src: "/images/community/coach.jpg", title: "Mentorship", subtitle: "Coaches guiding the next generation" },
        { src: "/images/community/happy2.jpeg", title: "Positive Energy", subtitle: "Enthusiasm that inspires everyone" }
      ]
    : [
        { src: "https://images.unsplash.com/photo-1516731415730-0c607149933a?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Unity & Support", subtitle: "We win together, we lose together" },
        { src: "https://images.unsplash.com/photo-1613446184948-b05f1c5cbbdb?q=80&w=2352&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Mentorship", subtitle: "Coaches guiding the next generation" },
        { src: "https://plus.unsplash.com/premium_photo-1679245158854-9ecb7449edda?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Positive Energy", subtitle: "Enthusiasm that inspires everyone" }
      ];
...
            <Card key={idx} className="overflow-hidden border-2 border-gray-200 hover:border-orange-400 shadow-xl hover:shadow-2xl transition-all group">
