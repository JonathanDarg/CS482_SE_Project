...
export function Community() {
  ...
  // --- SAME LOGIN FUNCTION YOU USE IN HERO ---
  useEffect(() => {
    const userData = localStorage.getItem("user");
    setIsLoggedIn(!!userData);
  }, []);

  // --- LOGGED-IN IMAGES (LOCAL) ---
  ...
  // --- LOGGED-OUT IMAGES (UNSPLASH) ---
  const loggedOutPhotos = [
    {
      id: 1,
      src: "https://plus.unsplash.com/premium_photo-1679245158854-9ecb7449edda?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0",
      title: "Team Spirit",
      description: "Our teams building friendships and memories",
    },
    {
      id: 2,
      src: "https://images.unsplash.com/photo-1537138844604-ed3f6b5e9637?q=80&w=3024&auto=format&fit=crop",
      title: "Game Day Fun",
      description: "Kids learning and having a blast",
    },
    {
    ...
    {
      id: 4,
      src: "https://images.unsplash.com/photo-1643225753232-ad7d041ed0f7?q=80&w=987&auto=format&fit=crop",
      title: "Practice Makes Perfect",
      description: "Developing skills through dedicated training",
    },
    {
    ...
    {
      id: 7,
      src: "https://images.unsplash.com/photo-1551675310-d9e5b35221cb?q=80&w=1335&auto=format&fit=crop",
      title: "Community Gathering",
      description: "Bringing families together through baseball",
    },
    {
  ...
  // choose which set of photos to show
  const communityPhotos = isLoggedIn ? loggedInPhotos : loggedOutPhotos;
          ...
          {communityStats.map((stat, index) => (
            ...
            >
              <CardContent className="p-6 flex flex-col items-center justify-center text-center">
                <div className="text-6xl text-orange-500 mb-2">{stat.number}</div>
                <p className="text-2xl font-semibold text-gray-800 mb-1">{stat.label}</p>
