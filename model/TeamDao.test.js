...
describe('TeamDao', () => {
  ...
  describe('createTeam', () => {
    it('should create and save a team', async () => {
      const teamData = { teamName: 'Lions', teamLogo: 'logo.png' };
  ...
  describe('readOneTeam', () => {
    it('should return one team by id', async () => {
      const team = { _id: '1', teamName: 'Lions' };
  ...
  describe('updateTeam', () => {
    it('should update and return the team', async () => {
      const updatedTeam = { _id: '1', teamName: 'Lions Updated' };
      TeamModel.findByIdAndUpdate.mockResolvedValue(updatedTeam);

      const result = await TeamDao.updateTeam('1', { teamName: 'Lions Updated' });
  ...
  describe('deleteTeam', () => {
    it('should delete a team', async () => {
      TeamModel.findByIdAndDelete.mockResolvedValue();
  ...
  describe('deleteAll', () => {
    it('should delete all teams', async () => {
      TeamModel.deleteMany.mockResolvedValue();
